...
when "redhat", "centos", "scientific", "oracle"
  ...
  if node['platform_version'].to_f < 6.0
    ...
    default['postgresql']['server']['packages'] = %w{postgresql-server}
    default['postgresql']['contrib']['packages'] = %w{postgresql-contrib}
    default['postgresql']['jdbc']['packages'] = %w{postgresql-jdbc}
    default['postgresql']['jdbc']['jar'] = "/usr/share/java/postgresql-8.4-703.jdbc4.jar"
    default['postgresql']['dir'] = "/var/lib/pgsql/data"
    default['postgresql']['server']['service_name'] = "postgresql"
  else
    default['postgresql']['client']['packages'] = ["postgresql#{ver}-devel"]
    default['postgresql']['server']['packages'] = ["postgresql#{ver}-server"]
    default['postgresql']['contrib']['packages'] = ["postgresql#{ver}-contrib"]
    default['postgresql']['jdbc']['packages'] = ["postgresql#{ver}-jdbc"]
    default['postgresql']['jdbc']['jar'] = "/usr/share/java/postgresql#{ver}-jdbc.jar"
